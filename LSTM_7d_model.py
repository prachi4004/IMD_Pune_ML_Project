...
model = Sequential()
model.add(LSTM(100, input_shape=(7, 1), return_sequences=True))
model.add(Dropout(0.2))
model.add(LSTM(50))
model.add(Dropout(0.2))
model.add(Dense(1, activation='relu'))  # Use ReLU activation for positive rainfall predictions
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('loss_Vs_Epochs_lstm_7d_model.png')
...
model.save('Panjim_LSTM_7d_model.h5')
